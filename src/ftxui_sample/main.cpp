...
// configuration step. It creates a namespace called `cpp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp::cmake::project_name, cpp::cmake::project_version) };
